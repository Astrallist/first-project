...
const BurgerConstructor = () => {
	...
	const renderSelectedIngredients = (type, bunType) => {
		...
		return (
			<>
				{filteredIngredients.map((ingredient) => (
					<div className={burgerConstructorStyles.elementLine} key={ingredient._id}>
	...
	return (
		<div className={burgerConstructorStyles.burgerConstructorView}>
			<ul className={burgerConstructorStyles.container}>
				<div className='mb-4'>{renderSelectedIngredients('bun', 'top')}</div>
				<div className={burgerConstructorStyles.list}>
					{renderSelectedIngredients('sauce')}
					{renderSelectedIngredients('main')}
				</div>
				<div className='mt-4'>{renderSelectedIngredients('bun', 'bottom')}</div>
			</ul>
			<div className={burgerConstructorStyles.results}>
				<p className='text text_type_digits-medium'>5336</p>
			...
			{isOrderModalOpen && (
				<Modal type='order' content='099465' onClose={closeOrderModal}>
					<p>Заказ оформлен</p>
				</Modal>
			)}
		</div>
